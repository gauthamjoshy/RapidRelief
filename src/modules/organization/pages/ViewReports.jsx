              ...
              <div>
                ...
                {allReports?.length > 0 ?
                  allReports.map((item, index) => (
                    <div key={index} className="bg-white shadow-lg rounded-xl border p-15 md:mx-10 my-20">
                      {/* Header */}
                      ...
                      <div className="mt-6">
                        ...
                        <div className="mt-3 flex flex-col gap-2 text-gray-700">
                          ...
                          <div className="text-gray-600 text">Reported by : <span className='text-lg font-semibold text-gray-700'>{item?.name}</span> </div>
