...
function OrgDashboard() {
  ...
  useEffect(() => {
    ...
    const orgToken = sessionStorage.getItem("token")
        ...
        <div className='md:mb-10'>
          ...
          {assignedReports?.length > 0 ?
            assignedReports.map((item, index) => (
              <div key={index} className="bg-white shadow-lg rounded-xl p-8 border me-10">
                {/* Header */}
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-3 flex flex-col gap-2 text-gray-700">
                    ...
                    <div className="text-gray-600 text-sm"><span className='text-lg font-semibold text-gray-700'>Updated at : {item?.updatedAt}</span></div>

                    <div className="text-gray-600 text-sm"><span className='text-lg font-semibold text-gray-700'>Reported by : {item?.name}</span></div>
                    <div className="flex items-center gap-2">
